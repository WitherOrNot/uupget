...
"""
    ...
    def device_attributes(self, build, branch, ring, arch, sku, flight, rs_type, **kwargs):
        ...
        return escape("E:" + "&".join([
                ...
                "CloudPBR=1",
                "DUScan=1",
                "OEMModel=Bingus Dingus",
                "OEMModelBaseBoard=BINGUS DINGUS",
                "OEMName_Uncleaned=BINGUS DINGUS LLC",
                "OSArchitecture=" + arch,
                "OSSkuId=" + str(sku_id),
                "OSUILocale=en-US",
                "OSVersion=" + build,
                "ProcessorIdentifier=Intel64 Family 69 Model 1337 Stepping 0",
                ...
                "TelemetryLevel=3",
                "TimestampEpochString_CO21H2=" + str(int(time()) - 3600),
                "TimestampEpochString_CO21H2Setup=" + str(int(time()) - 3600),
                "TimestampEpochString_21H2="  + str(int(time()) - 3600),
